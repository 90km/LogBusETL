...
public class ItemConvert extends ConvertBase {
     ...
     */
    public ItemConvert(String input, String output) throws IOException {
        super(input, output);
    }
    ...
    public void jsonConvert() throws IOException {
        ...
        while ((line = br.readLine()) != null) {
            ...
            // 必须配置EventName
            newObject.addProperty("#event_name", "KP_item_new");
            try {
                ...
                userProperty.addProperty("itemid", object.get("itemid").getAsInt());
                userProperty.addProperty("value", object.get("value").getAsInt());
                userProperty.addProperty("from_pid", object.get("from_pid").getAsBigInteger());
                userProperty.addProperty("after", object.get("after").getAsInt());
                userProperty.addProperty("amount", object.get("amount").getAsInt());
                userProperty.addProperty("amount2", object.get("amount2").getAsInt());
