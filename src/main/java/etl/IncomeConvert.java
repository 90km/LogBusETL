...
public class IncomeConvert extends ConvertBase {
     ...
     */
    public IncomeConvert(String input, String output) throws IOException {
        super(input, output);
        br = super.getBr();
        bw = super.getBw();
    }
    ...
    public void jsonConvert() throws IOException {
        ...
        while ((line = br.readLine()) != null) {
            ...
            // 必须配置EventName
            newObject.addProperty("#event_name", "KP_income_new");
            try {
