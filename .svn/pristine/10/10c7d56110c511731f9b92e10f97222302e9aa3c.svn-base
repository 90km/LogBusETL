...
public class ChargeConvert extends ConvertBase {
     ...
     */
    public ChargeConvert(String input, String output) throws IOException {
        super(input, output);
        br = super.getBr();
        bw = super.getBw();
    }
    ...
    public void jsonConvert() throws IOException {
        ...
        while ((line = br.readLine()) != null) {
            ...
            // 必须配置EventName
            newObject.addProperty("#event_name", "KP_charge_new");
            try {
                ...
                newObject.addProperty("#time",
                    DateUtil.convertTimeZone(object.get("timeDateTimeStr").getAsString()));
                ...
                userProperty.addProperty("oid", object.get("oid").getAsString());
                userProperty.addProperty("type", object.get("type").getAsString());
                userProperty.addProperty("level", object.get("level").getAsInt());
                userProperty.addProperty("amount", object.get("amount").getAsFloat());
                userProperty.addProperty("coins", object.get("coins").getAsInt());
                userProperty.addProperty("mark", object.get("mark").getAsInt());
                userProperty.addProperty("name", object.get("name").getAsString());
                String ctime = DateUtil.timeStamp2Date(object.get("ctime").getAsString());
                userProperty.addProperty("ctime", ctime);
                userProperty.addProperty("currencyType", object.get("currencyType").getAsString());
