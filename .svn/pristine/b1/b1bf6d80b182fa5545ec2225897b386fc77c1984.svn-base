...
public class ConsumeConvert extends ConvertBase {
     ...
     */
    public ConsumeConvert(String input, String output) throws IOException {
        super(input, output);
        br = super.getBr();
        bw = super.getBw();
    }
    ...
    public void jsonConvert() throws IOException {
        ...
        while ((line = br.readLine()) != null) {
            ...
            // 必须配置EventName
            newObject.addProperty("#event_name", "KP_consume_new");
            try {
                ...
                userProperty.addProperty("coin_type", object.get("coin_type").getAsInt());
