...
public class PropsConvert extends ConvertBase {
     ...
     */
    public PropsConvert(String input, String output) throws IOException {
        super(input, output);
    }
    ...
    public void jsonConvert() throws IOException {
        ...
        while ((line = br.readLine()) != null) {
            ...
            // 必须配置EventName
            newObject.addProperty("#event_name", "KP_props_new");
            try {
