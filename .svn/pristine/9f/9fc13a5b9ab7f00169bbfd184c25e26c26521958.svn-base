...
public class LevelConvert extends ConvertBase {
     ...
     */
    public LevelConvert(String input, String output) throws IOException {
        super(input, output);
    }
    ...
    public void jsonConvert() throws IOException {
        ...
        while ((line = br.readLine()) != null) {
            ...
            // 必须配置EventName
            newObject.addProperty("#event_name", "KP_level_new");
            try {
                ...
                userProperty.addProperty("from", object.get("from").getAsInt());
                userProperty.addProperty("to", object.get("to").getAsInt());
