...
export LOG_DIR=/home/centos/longsl/tag/logbuslog
...
echo "---> s3cmd get -fr s3://kp-aws-logs-eu/kp-logs/eu/${EVENT_NAME}/${YEAR}/${MONTH}/*"
s3cmd get -fr s3://kp-aws-logs-eu/kp-logs/eu/${EVENT_NAME}/${YEAR}/${MONTH}

# log file and convert file 
LOG_FILE=log.eu.${YEAR}-${MONTH}_${EVENT_NAME}
LOG_FILE_COV=log.eu.${YEAR}-${MONTH}_${EVENT_NAME}_cov
...
echo "---> gzip -dcr s3://kp-aws-logs-eu/kp-logs/eu/${EVENT_NAME}/${YEAR}/${MONTH}/* >$LOG_FILE"
